...
public extension UICollectionViewCell {
    ...
    func ad_preferredCellLayoutHeight(fittingWidth: CGFloat) -> CGFloat {
        return ad_preferredCellLayoutSize(fittingWidth: fittingWidth).height
    }
    ...
    /**
     ...
     - parameter fittingWidth: The biggest width the view can get
     */
    func ad_preferredCellLayoutSize(fittingWidth: CGFloat) -> CGSize {
        return contentView.ad_preferredLayoutSize(fittingWidth: fittingWidth)
    }
     ...
     */
    func ad_preferredCellLayoutSize(fittingHeight: CGFloat) -> CGSize {
        return contentView.ad_preferredLayoutSize(fittingHeight: fittingHeight)
    }
}
